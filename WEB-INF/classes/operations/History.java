...
public String getDbname(DataManager db,Student s,String sem)
 {
	 ...
	 String query="select batchno,coursecode from student_master.financestudent where registerno='"+s.getRegisterno()+"'";
	 ...
	 if(db.operation(query, "select"))
	 {
      ...
      String query2="select `database` from student_master.alldatabases1 where cyear="+required_year+" and semester="+tempsem+" and coursecode='"+course+"'";
