...
public class Student_selection {
	...
	
	{
		...
		String query="select registerno from student_master.student_faculty where empcode='"+cs.getEmpcode()+"'";
	...
	public boolean getBatchno(Student register,DataManager db) //To return Batch Number :: start
	{
		...
		String query="select batchno from student_master.student where registerno='"+register.getRegisterno()+"'";
	...
	{
		String query="select name,landline,studentmobile,fathermobile,studentemailid,parentemailid from student_master.student where registerno='"+s.getRegisterno()+"'";
		boolean t=db.operation(query,"select");
		if(t)
		{
			try
	...
	public int retrival(DataManager db,Student register) throws SQLException
	{
		...
		String str="select cyear,semester from student_master.student where registerno='"+register.getRegisterno()+"'";
	...
	public String[] getSection(DataManager db,int y,int se,String course,String branch)
	{
		...
		String query="select section from student_master.sections where coursecode='"+course+"' and branchcode='"+branch+"' and year='"+y+"' and semester='"+se+"'";
